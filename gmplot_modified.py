...
class GoogleMapPlotter(object):
    ...
    def __init__(self, center_lat, center_lng, zoom):
        ...
        self.coloricon = os.path.join(os.path.dirname(__file__), 'markers/%s.png')      # MODIFIED
        # self.coloricon = '/'.join(self.coloricon.split('\\'))                           # MODIFIED
    ...
    def draw(self, htmlfile):
        ...
        f.write('<title>Dream Theater - Images, Words & Beyond</title>\n')
